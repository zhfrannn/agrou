...
export default function AboutPage() {
  return (
    <div className="w-full min-h-screen bg-[#FFFDF7] font-sans">
      ...
      <section className="relative pt-24 pb-0 overflow-hidden bg-linear-to-b from-[#FFFDF7] to-orange-50/30">
        ...
        <div className="w-full mt-16 relative">
          ...
          <div className="w-full aspect-[21/9] md:aspect-[21/6] relative bg-linear-to-t from-orange-100 via-orange-50 to-transparent overflow-hidden border-b-8 border-[#2D6A4F]">
            ...
            <div className="absolute inset-0 flex">
              ...
              <div className="w-1/2 bg-[url('https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=1200')] bg-cover bg-right opacity-60">
                 <div className="absolute inset-0 bg-linear-to-r from-[#2D6A4F]/40 to-transparent mix-blend-multiply"></div>
              </div>
              ...
              <div className="w-1/2 bg-[url('https://images.unsplash.com/photo-1533659288225-78e7c1f83c07?auto=format&fit=crop&q=80&w=1200')] bg-cover bg-left opacity-60">
                 <div className="absolute inset-0 bg-linear-to-l from-[#F77F00]/40 to-transparent mix-blend-multiply"></div>
              </div>
            </div>
            {/* Center blend overlay */}
            <div className="absolute inset-x-0 bottom-0 top-0 left-1/2 -translate-x-1/2 w-64 bg-linear-to-r from-transparent via-[#FFFDF7]/80 to-transparent"></div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 w-full relative">
              <div className="aspect-[4/3] rounded-[2rem] bg-orange-100 overflow-hidden shadow-2xl relative border-8 border-white p-2">
                 ...
                 />
                 <div className="absolute inset-0 bg-linear-to-t from-orange-900/40 to-transparent rounded-3xl"></div>
              </div>
      ...
      <section className="py-24 bg-linear-to-br from-[#F77F00] to-[#2D6A4F] relative overflow-hidden">
