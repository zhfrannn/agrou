...
const FEATURED_KOPERASI = [
  {
    ...
    cover:
      "https://images.unsplash.com/photo-1524803507119-a9a3b6f2fb48?auto=format&fit=crop&q=80&w=800",
    ...
    products: [
      {
        ...
        price: "Rp 150rb",
        image:
          "https://images.unsplash.com/photo-1621852004158-f3bc188ace2d?auto=format&fit=crop&q=80&w=200",
      },
      {
        name: "Ebi Kering",
        price: "Rp 90rb",
    ...
    products: [
      {
        ...
        price: "Rp 18rb",
        image:
          "https://images.unsplash.com/photo-1587049352847-4d4b1ed74dc4?auto=format&fit=crop&q=80&w=200",
      },
      {
        name: "Fleur de Sel",
        price: "Rp 45rb",
...
export default function PasarPage() {
  ...
  const filteredProducts = PRODUCTS.filter((p) => {
    ...
    // 3. Koperasi Filter
    const matchesKoperasi =
      !selectedFilterKoperasi || p.koperasi === selectedFilterKoperasi;
    // 4. Verified Status Filter
    const matchesVerified = !onlyVerified || p.verified;
    // 5. Min Stock Filter
    const stockVal =
      parseFloat(p.stock.replace(/[^0-9.]/g, "")) *
      (p.stock.toLowerCase().includes("ton") ? 1000 : 1);
    const matchesStock = !minStockLimit || stockVal >= minStockLimit;
    // 6. Min Order Filter
    const minOrderVal =
      parseFloat(p.minOrder.replace(/[^0-9.]/g, "")) *
      (p.minOrder.toLowerCase().includes("ton") ? 1000 : 1);
    ...
    <div className="w-full bg-(--color-cream) min-h-screen">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-10 px-6 md:px-14 min-h-80">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              >
                ...
                <br />
                <span className="text-(--color-lime) italic">
                  dari Koperasi Desa.
                </span>
              </h1>
              ...
              <p className="text-white/75 text-sm md:text-base leading-relaxed mb-6 max-w-xl font-medium text-left">
                Temukan hasil panen terbaik langsung dari koperasi desa
                terverifikasi — tanpa perantara, harga adil, kualitas terjamin
                dari sumber aslinya.
              </p>
              ...
              <div className="flex items-center gap-5 mt-5 pt-5 border-t border-white/10 max-w-xl">
                {[
                  ...
                  <div key={label} className="flex flex-col text-left">
                    <span className="text-(--color-lime) font-black text-lg font-sans">
                      {num}
                    </span>
                    <span className="text-white/50 text-[10px] font-sans tracking-wide mt-0.5">
                      {label}
                    </span>
                  </div>
                ))}
            ...
            <div className="lg:col-span-5 flex justify-center lg:justify-end w-full">
              {orderSubmitted ? (
                <div className="bg-white rounded-3xl p-6 shadow-2xl w-full max-w-85 text-gray-800 border border-white/20 relative z-20 flex flex-col items-center justify-center text-center min-h-88 animate-fade-in">
                  ...
                  <h3 className="font-sans font-extrabold text-lg text-[#0d2918]">
                    Permintaan Terkirim!
                  </h3>
                  <p className="text-gray-500 text-xs mt-2 leading-relaxed px-2">
                    Permintaan untuk Koperasi{" "}
                    <strong>{selectedKoperasi || "Mitra"}</strong> untuk
                    komoditas <strong>{selectedKomoditas || "Terpilih"}</strong>{" "}
                    dengan tujuan{" "}
                    <strong>{shippingDest || "Lokasi Anda"}</strong> berhasil
                    dibuat. Petani akan segera menghubungi Anda.
                  </p>
                  <button
                    onClick={() => {
                ...
                <div className="bg-white rounded-3xl p-6 shadow-2xl w-full max-w-85 text-gray-800 border border-white/20 relative z-20">
                  <div className="mb-4 text-left">
                    <h3 className="font-sans font-extrabold text-lg text-[#0d2918] tracking-tight">
                      Pesan Cepat
                    </h3>
                    <p className="text-gray-400 text-[11px]">
                      Hubungi langsung koperasi petani
                    </p>
                  </div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        {FEATURED_KOPERASI.map((kop) => (
                          <option key={kop.id} value={kop.name}>
                            {kop.name}
                          </option>
                        ))}
                        <option value="Koperasi Bahari Jaya">
                          Koperasi Bahari Jaya
                        </option>
                        <option value="KUD Samudra Hijau">
                          KUD Samudra Hijau
                        </option>
                      </select>
                  ...
                  <div className="mt-4 mb-5 text-left">
                    <div className="text-[10px] uppercase tracking-wider font-extrabold text-gray-400 mb-2">
                      Mitra Pilihan
                    </div>
                    <div className="flex items-center gap-1.5">
                      {FEATURED_KOPERASI.map((kop) => (
                        <div
                          ...
                          onClick={() => setSelectedKoperasi(kop.name)}
                        >
                          <img
                            src={kop.logo}
                            alt={kop.name}
                      ...
                      <div
                        className="relative group cursor-pointer"
                        onClick={() => setSelectedKoperasi("KUD Subur Makmur")}
                      >
                        <img
      ...
      <div className="max-w-360 mx-auto px-8 py-10 lg:py-14">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="font-display font-black text-2xl text-(--color-forest-dark)">
              Koperasi Pilihan Minggu Ini
            </h2>
            <p className="text-(--color-text-secondary) text-sm mt-1">
              Koperasi desa terverifikasi dengan rekam jejak proteksi lahan dan
            ...
            <div className="bg-[#fcf7ee] rounded-3xl p-8 border border-(--color-border) shadow-sm flex flex-col justify-between relative overflow-hidden flex-1 group hover:shadow-md transition-shadow duration-300">
              ...
              <div className="relative z-20">
                ...
                <p className="text-(--color-text-secondary) text-xs mt-3 leading-relaxed max-w-70 text-left">
                  Kami menghubungkan Anda langsung dengan koperasi desa yang
                  telah melewati proses kurasi ketat untuk memastikan kualitas
                  hasil tani terbaik dan keberlanjutan lingkungan lahan.
                </p>
              </div>
            ...
            <div className="bg-white rounded-3xl p-8 border border-(--color-border) shadow-sm hover:shadow-md transition-all duration-300 text-left flex flex-col justify-between min-h-55">
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[9px] bg-green-50 text-green-700 font-extrabold px-2 py-0.5 rounded">
                    ONLINE
                  </span>
                </div>
                ...
                {chatMessage ? (
                  <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 text-xs text-gray-700 mb-4 animate-fade-in text-left">
                    <div className="font-bold text-[9px] text-(--color-orange-dark) mb-1 uppercase tracking-wider">
                      Asisten Agrou:
                    </div>
                    <p className="leading-relaxed">
                      Untuk rekomendasi komoditas sesuai pencarian Anda, saya
                      menyarankan <strong>KUD Subur Makmur</strong> untuk Beras
                      Organik premium, atau{" "}
                      <strong>Koperasi Tani Maju Gayo</strong> untuk Kopi
                      Arabika berkualitas tinggi.
                    </p>
                    <button
                  ...
                  <>
                    <p className="text-[11px] text-gray-500 mb-3 leading-relaxed">
                      Tulis komoditas atau lokasi yang dicari untuk mendapatkan
                      rekomendasi koperasi terbaik secara instan.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-4">
                      {[
                        {
                          label: "🌾 Cari Beras",
                          text: "Saya ingin membeli beras Cianjur premium",
                        },
                        {
                          label: "☕ Kopi Gayo",
                          text: "Tunjukkan koperasi penghasil kopi Gayo Arabika",
                        },
                        {
                          label: "🦐 Udang Segar",
                          text: "Cari produsen udang vaname berkualitas",
                        },
                      ].map((preset) => (
                        <button
                          key={preset.label}
                  ...
                  <div className="pt-6 px-4 flex-1 flex flex-col text-left">
                    ...
                    <div className="flex flex-wrap gap-1 mt-1.5">
                      {kop.tags.map((tag) => (
                        <span
                          key={tag}
                          className="bg-gray-100 text-gray-600 text-[8px] font-extrabold px-1.5 py-0.5 rounded"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="grid grid-cols-3 gap-1.5 mt-3">
                      {kop.products.map((p, pIdx) => (
                        <div
                          key={pIdx}
                          className="bg-gray-50 rounded-xl p-1 border border-gray-100 flex flex-col justify-between min-h-20.5 hover:border-gray-200 transition-colors"
                        >
                          ...
                          <div className="mt-1 flex flex-col justify-end">
                            <div
                              className="text-[7.5px] font-extrabold text-gray-700 truncate w-full text-left leading-none"
                              title={p.name}
                            >
                              {p.name}
                            </div>
      ...
      <div className="max-w-360 mx-auto px-8 pb-16">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="font-display font-black text-xl text-(--color-forest-dark)">
              Produk Tersedia Sekarang
            </h2>
            <p className="text-sm text-(--color-text-secondary) mt-0.5">
              Langsung dari koperasi, siap dipesan hari ini
            </p>
          </div>
        </div>
            ...
            <div className="bg-white rounded-3xl p-5 border border-(--color-border) shadow-sm text-left flex flex-col gap-5">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-gray-100">
                <h3 className="font-sans font-black text-xs text-(--color-forest-dark) tracking-wider uppercase flex items-center gap-1.5">
                  <svg
                    className="w-4 h-4 text-(--color-orange) animate-pulse"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div>
                <label className="block text-[9px] uppercase tracking-wider font-black text-gray-400 mb-2">
                  Kategori Komoditas
                </label>
              ...
              <div>
                <label className="block text-[9px] uppercase tracking-wider font-black text-gray-400 mb-1.5">
                  Cari Komoditas
                </label>
                <div className="relative">
                  <input
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    {
                      name: "Siti Rahma",
                      title: "KUD Subur Makmur",
                      role: "padi",
                      roleLabel: "Padi",
                      avatar:
                        "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=100",
                      active: activeCategory === "padi",
                    },
                    {
                      name: "Pak Slamet",
                      ...
                      active: activeCategory === "ikan",
                    },
                  ].map((p, index) => (
                    <div
                      key={index}
                      onClick={() =>
                        setActiveCategory(p.active ? "semua" : p.role)
                      }
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-[10px] font-black text-(--color-forest-dark) leading-none mb-0.5">
                          {p.name}
                        </div>
                        <div className="text-[8.5px] text-gray-400 font-medium truncate">
                          {p.title}
                        </div>
                      </div>
                      <span className="text-[7.5px] bg-gray-100 text-gray-500 font-bold px-1.5 py-0.5 rounded-full shrink-0">
                        {p.roleLabel}
                      </span>
                    </div>
                  ))}
              ...
              <div className="space-y-3 pt-3 border-t border-gray-100">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-[8px] uppercase tracking-wider font-extrabold text-gray-400 mb-1">
                      Min Order
                    </label>
                    <div className="flex items-center gap-1.5 bg-gray-50 border border-gray-200 rounded-xl px-2 py-1">
                      <button
                        onClick={() =>
                          setMinOrderLimit(Math.max(0, minOrderLimit - 5))
                        }
                        className="text-gray-500 hover:text-black font-extrabold text-xs cursor-pointer select-none"
                      >
                        -
                      </button>
                      <span className="text-[10px] font-black text-gray-700 flex-1 text-center">
                        {minOrderLimit || 0} kg
                      </span>
                      <button
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-xl px-2 py-1">
                      <button
                        onClick={() =>
                          setMinStockLimit(Math.max(0, minStockLimit - 10))
                        }
                        className="text-gray-500 hover:text-black font-extrabold text-xs cursor-pointer select-none"
                      >
                        -
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        onChange={(e) =>
                          setSelectedFilterKoperasi(e.target.value)
                        }
                        className="w-full bg-gray-50 border border-gray-200 text-gray-700 rounded-xl pl-2.5 pr-6 py-1.5 text-[9.5px] font-bold focus:outline-none focus:ring-1 focus:ring-(--color-orange) appearance-none cursor-pointer"
                      >
              ...
              <button
                onClick={() => {
                  alert(
                    `Berhasil memfilter: ditemukan ${filteredProducts.length} produk`,
                  );
                }}
            ...
            {filteredProducts.length === 0 ? (
              <div className="py-24 bg-white rounded-3xl border border-(--color-border) flex flex-col items-center text-center">
                ...
                <p className="text-gray-400 text-sm">
                  Coba sesuaikan filter atau kategori lain
                </p>
              </div>
            ) : (
              (() => {
                      ...
                      {paginatedProducts.map((prod, idx) => (
                        ...
                        >
                          ...
                          <div className="p-2 flex-1 flex flex-col justify-between">
                            <div>
                              <h3 className="font-extrabold text-[10px] text-(--color-text-primary) leading-tight mb-0.5 line-clamp-2 min-h-6">
                                {prod.name}
                              </h3>
                              ...
                              <div className="flex items-center justify-between text-[8px] bg-gray-50 px-2 py-1 rounded-lg border border-gray-100 mt-1.5">
                                <div>
                                  ...
                                  <span className="font-extrabold text-(--color-forest-dark)">
                                    {prod.stock}
                                  </span>
                                </div>
                            ...
                            <div className="mt-2.5">
                              <div className="text-(--color-orange) font-black text-sm">
                                {prod.price}
                                <span className="text-gray-400 text-[9px] font-normal ml-0.5">
                                  {prod.unit}
                                </span>
                              </div>
      ...
      <div className="fixed bottom-6 right-6 z-50 group">
        <button
          ...
          style={{
            boxShadow:
              "0 0 0 0 rgba(247,127,0,0.4), 0 8px 32px rgba(247,127,0,0.35)",
          }}
        >
