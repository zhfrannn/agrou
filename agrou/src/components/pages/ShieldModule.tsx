...
const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description:
      "Kuat menahan cuaca ekstrem, investasi jangka panjang nelayan.",
    price: "Rp 350.000",
    image:
        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between items-end mb-12 gap-6">
          <div className="max-w-2xl text-white">
            ...
            <p className="text-white/80 text-lg font-medium">
              Lindungi masa depan panen dan tangkapanmu dengan solusi
              perlindungan tepercaya. Aman, bersahabat, dan dapat diandalkan!
            </p>
          </div>
          ...
          {MOCK_PRODUCTS.map((product, idx) => (
            ...
            >
              <div className="h-48 relative overflow-hidden">
                ...
                {product.badge && (
                  <div
                    className={`absolute top-4 left-4 ${product.badgeColor} text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-md`}
                  >
                    {product.badge}
                  </div>
                )}
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <p className="text-gray-500 font-medium text-sm mb-6 flex-1 line-clamp-2">
                  {product.description}
                </p>
