  ...
  return (
    <div className='w-full bg-[#FFFDF7] min-h-screen pb-24'>
      ...
      <section className='w-full h-[320px] relative bg-[#1a1a2e]'>
        ...
        <div className='absolute top-6 right-8 bg-linear-to-r from-[#1a6b8a] to-[#0e4d6e] text-white px-4 py-2.5 rounded-full shadow-xl flex items-center gap-2 border border-white/20 backdrop-blur-md'>
          <Globe size={16} />
            ...
            <motion.div key='dokumen' initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.2 }}>
              {isTabLoading ? (
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                  ...
                  <div className='lg:col-span-4'>
                    <div className='bg-linear-to-br from-[#1a6b8a]/10 to-[#0e4d6e]/5 rounded-2xl p-6 border border-[#1a6b8a]/20'>
