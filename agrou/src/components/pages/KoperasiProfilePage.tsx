  ...
  return (
    <div className="w-full bg-[#FFFDF7] min-h-screen pb-24">
      ...
      <section className="w-full h-[320px] relative bg-[#2c1c14]">
        ...
        <div className="absolute inset-0 bg-linear-to-b from-black/30 to-transparent h-32"></div>

        {/* Floating Badge overlay top-right */}
        <div className="absolute top-6 right-8 bg-linear-to-r from-[#FFB703] to-[#F77F00] text-white px-4 py-2.5 rounded-full shadow-xl flex items-center gap-2 border border-white/20 backdrop-blur-md">
                ...
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="aspect-[4/3] rounded-2xl overflow-hidden group relative">
                      ...
                      <div className="absolute left-0 bottom-0 w-full p-4 bg-linear-to-t from-black/80 to-transparent">
              ...
              <div className="lg:col-span-4 space-y-6">
                ...
                <div className="bg-[#2D6A4F] text-white p-6 rounded-2xl shadow-xl shadow-[#2D6A4F]/20 relative overflow-hidden">
                   ...
                   <div className="flex items-center gap-3 mb-4">
                     <div className="bg-linear-to-tr from-[#FFB703] to-[#F77F00] w-12 h-12 rounded-xl flex items-center justify-center shrink-0 shadow-lg border border-white/20">
                   ...
                   <div>
                     ...
                     <div className="w-full bg-black/20 rounded-full h-2 mb-2 border border-white/10">
                       <div className="bg-linear-to-r from-[#FFD166] to-[#F77F00] h-2 rounded-full shadow-[0_0_10px_#F77F00]" style={{ width: '80%' }}></div>
                     </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 xl:gap-8">
                  ...
                  >
                    ...
                    <div className="h-56 relative overflow-hidden bg-gray-100">
                      ...
                      <div className="absolute top-3 right-3 bg-linear-to-r from-[#FFB703] to-[#F77F00] w-8 h-8 rounded-full shadow-lg border border-white/20 flex flex-col items-center justify-center">
