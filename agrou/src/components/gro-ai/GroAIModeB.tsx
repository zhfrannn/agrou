...
export default function GroAIModeB({ onBack }: { onBack: () => void }) {
  ...
  const RightPanelInner = () => (
    ...
    >
      ...
      <div className="relative">
        <div className="h-20 bg-linear-to-br from-[#f77f00]/80 to-[#c85a00]/90 flex items-end px-4 pb-2">
          ...
          <div className="bg-black/5 border border-black/10 rounded-2xl p-4">
            ...
            <div className="space-y-2.5">
              {[
                ...
                >
                  <span className="text-[#4a6a4a] text-xs">{item.label}</span>
  ...
  return (
    ...
    >
      ...
      <div className="w-65 shrink-0 hidden lg:flex flex-col h-full border-r border-white/10">
        <SidebarInner />
      </div>
      ...
      <AnimatePresence>
        {leftOpen && (
          ...
          >
            ...
            />
            <motion.div
              className="absolute left-0 top-0 bottom-0 w-65 border-r border-white/10 overflow-y-auto"
              initial={{ x: -280 }}
              animate={{ x: 0 }}
              exit={{ x: -280 }}
