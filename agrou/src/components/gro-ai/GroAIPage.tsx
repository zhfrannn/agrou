  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, #b3cc04 1px, transparent 1px)",
          backgroundSize: "32px 32px",
        }}
      />
      <div className="absolute top-0 left-0 w-96 h-96 bg-[#b3cc04]/5 rounded-full blur-3xl pointer-events-none -translate-x-1/2 -translate-y-1/2" />
      ...
      >
        <div className="inline-flex items-center gap-2 bg-[#b3cc04]/10 border border-[#b3cc04]/30 text-[#b3cc04] text-[10px] font-black tracking-[0.15em] px-3.5 py-1.5 rounded-full mb-3 uppercase">
          <Sparkles size={10} />
        ...
        <h1 className="font-display font-black text-white text-3xl lg:text-4xl leading-[1.1] mb-1.5">
          Kamu siapa
          <span className="text-[#b3cc04] italic"> hari ini?</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 w-full max-w-5xl relative z-10">
        ...
        <motion.button
          ...
          className="group relative overflow-hidden rounded-3xl p-6 text-left cursor-pointer bg-linear-to-br from-white/8 via-white/5 to-transparent border border-white/10 hover:border-[#b3cc04]/50 hover:shadow-[0_0_60px_rgba(179,204,4,0.12),inset_0_1px_0_rgba(179,204,4,0.1)] transition-all duration-400"
        >
          <div className="absolute inset-0 bg-linear-to-br from-[#b3cc04]/8 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-400 pointer-events-none rounded-3xl" />
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#b3cc04]/5 rounded-full blur-2xl pointer-events-none group-hover:bg-[#b3cc04]/10 transition-all duration-400 -translate-y-1/2 translate-x-1/2" />
          <div className="w-12 h-12 rounded-xl bg-[#b3cc04]/10 border border-[#b3cc04]/20 flex items-center justify-center mb-4 group-hover:bg-[#b3cc04]/20 group-hover:border-[#b3cc04]/50 group-hover:shadow-[0_0_20px_rgba(179,204,4,0.2)] transition-all duration-300">
            <Sprout size={24} className="text-[#b3cc04]" />
          </div>
          <div className="text-[#b3cc04] text-[9px] font-black tracking-[0.15em] uppercase mb-2">
            Mode A
          </div>
          ...
          <div className="space-y-1.5 mb-4">
            {[
              ...
              <div key={f} className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 bg-[#b3cc04] rounded-full shrink-0" />
                <span className="text-white/60 text-xs font-medium">{f}</span>
              </div>
            ))}
          </div>
          <div className="flex items-center gap-2 text-[#b3cc04] font-black text-sm group-hover:gap-4 transition-all duration-300">
