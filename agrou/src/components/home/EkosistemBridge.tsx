...
const IMPACT_STATS = [
  ...
  },
  {
    ...
    prefix: "",
    suffix: "",
    label: "Target Koperasi Desa (Program Merah Putih)",
    type: "thousands",
  },
  {
    target: 37,
    prefix: "",
    suffix: " Juta",
    label: "Petani Indonesia yang Bisa Dijangkau",
    type: "integer",
  },
  {
    target: 30,
    prefix: "20–",
    suffix: "%",
    label: "Potensi Pengurangan Gagal Panen",
    type: "integer",
  },
];
                  ...
                  return (
                    <div key={i} className="flex items-center gap-1 shrink-0">
                      <div className="flex items-center gap-2 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl py-1.5 px-2.5 shadow-[0_4px_12px_rgba(0,0,0,0.03)] hover:shadow-md hover:scale-[1.01] transition-all duration-300 shrink-0">
                        <div
                          className={`${node.bg} w-6 h-6 rounded-lg flex items-center justify-center shrink-0`}
                        >
                      ...
                      {!isLast && (
                        <ArrowRight
                          size={12}
                          className="text-[var(--color-forest)]/40 shrink-0"
                          strokeWidth={2.5}
                        />
                      )}
                    </div>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-3xl p-6 lg:p-8 flex flex-col items-center justify-center text-center shadow-lg h-full">
              <div className="relative flex items-center justify-center mb-5">
                ...
                <div className="absolute flex flex-col items-center justify-center">
                  <span className="font-display font-black text-2xl lg:text-3xl text-[var(--color-text-primary)] leading-none">
                    62.8%
                  </span>
                </div>
              </div>
